...
@FeignClient(name = "customers-service", url = "http://internal-bookstore-dev-InternalALB-1133676349.us-east-1.elb.amazonaws.com:3000/customers", configuration = FeignConfig.class)
